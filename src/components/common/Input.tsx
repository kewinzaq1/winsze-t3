  ...
  ({ className, error, ...restProps }, ref) => {
    ...
    return (
      ...
      >
        <input
          type="text"
          className={`w-full rounded-md border border-slate-400 bg-white p-2 outline-none placeholder:truncate focus:border-slate-700  ${className} ${
            error ? "!border-red-500 pr-2 focus:!border-red-500" : ""
          }`}
          {...restProps}
          ref={ref}
        />
